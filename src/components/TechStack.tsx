  ...
  return (
    <div>
      ...
      <p>
        ...
        deployment. Keep scrolling if you wanna know why, how and what I work
        on!
      </p>
      ...
      <Tags
        tags={["JavaScript", "TypeScript", "Java", "C++" ,"SQL"]}
    ...
    <span className="block font-bold">Tools</span>
      <Tags
        tags={[ 'NodeJS 🟩', 'Prisma', 'Docker 🐳', 'Jenkins 🎩']}
        className="bg-gray-800 text-brand-accent"
      />
      <span className="block font-bold">Platforms</span>
      <Tags
        tags={['GitHub 🐙', 'AWS','Google Cloud','Vercel']}
        className="bg-gray-800 text-brand-accent"
      />
